...
contract Hyperbase is IHyperbase, ERC2771Context {  
    ...
    */
    ...
    /**
    * @dev Mapping from permission to key indexs.
    */
    mapping(uint256 => uint256[]) _keysByPermission;

    /**
    * @dev Mapping from permission const to amount of sigs required.
    */
    ...
    */
    ...
    /**
     * @dev Ensure the key has the required permission.
     */
    ...
    */
    ...
    function execute(
        ...
        transactionExecuted(getTransactionHash(targets, values, calldatas))
        returns (uint256)
    {
        // Get the by hash
        uint256 txHash = getTransactionHash(targets, values, calldatas);
